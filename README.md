...
![Supabase](https://img.shields.io/badge/Supabase-symbol%20%2B%20training%20store-3FCF8E?logo=supabase&logoColor=white)
...
data/           원천 캔들 parquet · watchlist · 임시 실행 캐시 (git 미추적)
Supabase        학습 메타데이터(Postgres) · 데이터셋/모델 파일(private Storage)
```
